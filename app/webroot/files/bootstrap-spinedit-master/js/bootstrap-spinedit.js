...
!function ($) {
	...
	$(template).each(function (i,x) {
        ...
        template.find('.glyphicon glyphicon-chevron-up').mousehold($.proxy(this.increase, this));
        template.find('.glyphicon glyphicon-chevron-down').mousehold($.proxy(this.decrease, this));
